...
public class Resident {
    ...
    private Integer fourWheelerCount; // Number of four-wheelers
	...
	public Resident(Long rId, String email, String fName, String mInit, String lName, Integer wingNo, Integer flatNo,
	...
	public String toString() {
		return "Resident [rId=" + rId + ", email=" + email + ", fName=" + fName + ", mInit=" + mInit + ", lName="
